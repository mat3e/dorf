 ...
 * DorfPropertiesToDefinitionsMap is used in AbstractDorfDetailsComponent to create metadata for all the form fields.
 *
...
export abstract class DorfDomainObject {
    abstract getFieldDefinitions(): PropertiesToDorfDefinitionsMap<DorfDomainObject>;
}
